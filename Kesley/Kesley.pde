...
void draw() {
  ...
  img = loadImage("Image Dataset"+ "//" + "/Kesley900.jpg");
  PImage gt_ref = loadImage("GroundTruths Dataset"+ "//" + "/Kesley900.jpg");
  PImage gt = loadImage("Processed"+ "//" + "/img_limiar.jpg");
  compareImages(gt,gt_ref);
  segmenta(img,gt);  
  save("Processed" + "//" + "19.jpg");
}
